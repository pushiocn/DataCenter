package org.pushio.datacenter.support;
...
import org.pushio.datacenter.util.JsonData;
import org.pushio.datacenter.util.JsonUtil;
import org.pushio.datacenter.util.NewJsonUtil;
...
public class Fastjson2HttpMessageConverter extends AbstractHttpMessageConverter<Object> {
    ...
    protected void writeInternal(Object obj, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
        ...
        if(obj instanceof Response) {
        	...
        	if(resp.getErrorcode() == ErrorCode.VALID_FAIL){
        		//验证错误信息直接输出JSON
